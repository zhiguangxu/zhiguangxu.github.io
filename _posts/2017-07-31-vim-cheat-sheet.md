...
- Fix indenting when pasting from the system clipboard: set paste (don't add it in .vimrc file though)
...
### Correct indentations in code file (e.g. hmtl)
- :set filetype=html
- highlight your code and hit `=`

### Reference
- Jordan Hudgens's page on Github